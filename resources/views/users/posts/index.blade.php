                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('user.post.edit' , $post->id )}}" class="btn btn-primary">Edit</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        ...
                                        @else 
                                        <div class="col-12">
                                           <h4> You don't have any post <span> <a href="{{route('user.post.create')}}" class="btn btn-primary">create </a></span> </h4>
                                        </div>
                                        @endif
