                ...
                <div class="song-details">
                    ...
                    <div class="music-player">
                        <div class="play-song">
                            ...
                            <audio src="{{ $template_source }}/music/The-Weeknd-Blinding-Lights-_Lyrics_.ogg" data-audio="darkfire"></audio>
                            <!--LINK AND NAME OF AUDIO YOU WANT TO PLAY-->
                        </div>
                        <div class="all-songs">
                            <a href="{{route('songs')}}" title="All Songs"><i class="gg-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
