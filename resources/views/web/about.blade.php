    ...
    <div class="heading-page header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text">
                        <a rel="nofollow" href="{{ route('media.about') }}" target="_parent">
                            <h4><b>ABOUT US</b></h4>
                        </a>
                    </div>
                </div>
            ...
            <div class="container" style="background-color:rgb(201, 198, 198)">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>
                        This site is well equipped and ready to serve your lastest,favorite,most trending,slow
                            groove,street anthems,top-ten bangers,
                            and next rated music/songs. We aren't going to be leaving you with just extreme music to enjoy but also with your latest and
                            most interesting music video and more importantly enjoyable movie!! we aren't stopping here more are yet to come.<strong> stay tune!!</strong></ul>
                        </p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>As a Media Creator we'll ensure best offer of music and movie,Be Assure!!</p>
                    </div>
                </div>
