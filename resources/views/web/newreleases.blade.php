...
<div id="sidebar-bg">
            ...
            <div id="header-user-notification-menu">
                ...
                <div id="header-notification-menu-padding">
                    <ul id="header-user-notification-list">
                        <li><a href="#!"><img src="{{ $admin_assets }}/skrn/images/demo/user-profile-2.jpg" alt="Profile">Lorem ipsum dolor
                                sit amet, consec tetur adipiscing elit. <div class="header-user-notify-time">21
                                    hours ago</div></a></li>
                        <li><a href="#!"><img src="{{ $admin_assets }}/skrn/images/demo/user-profile-3.jpg" alt="Profile">Donec vitae lacus
                                id arcu molestie mollis. <div class="header-user-notify-time">3 days ago</div></a>
                        </li>
                        <li><a href="#!"><img src="{{ $admin_assets }}/skrn/images/demo/user-profile-4.jpg" alt="Profile">Aenean vitae lectus
    ...
    <main id="col-main">
        ...
        <div class="dashboard-container">
            ...
            <h4 class="heading-extra-margin-bottom">All Songs</h4>
            <div class="row">
                @foreach($posts as $post)
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="item-listing-container-skrn">
                        <a href="dashboard-movie-profile.html"><img class="img-fluid music-image" src="{{ asset($post->cover_image)}}" alt="Listing"></a>
                        <div class="item-listing-text-skrn">
                            <div class="item-listing-text-skrn-vertical-align">
                                <h6><a href="dashboard-movie-profile.html">{{$post->name}}</a></h6>
