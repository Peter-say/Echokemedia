    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
            <div class="item-listing-container-skrn">
                <a href="{{route('post.show' , $relatedPost->slug)}}"><img class="music-image" src="{{asset( $relatedPost->cover_image)}}" alt="Listing"></a>
                <div class="item-listing-text-skrn">
                    <div class="item-listing-text-skrn-vertical-align">
                        <h6><a href="{{route('post.show' , $relatedPost->slug)}}">{{$relatedPost->name}}</a></h6>
