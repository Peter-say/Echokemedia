<head>
    ...
    <link rel="stylesheet" href="{{ $dashboard_assets }}/skrn/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ $dashboard_assets }}/skrn/style.css">
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Lato:400,700%7CMontserrat:300,400,600,700">

    <link rel="stylesheet" href="{{ $dashboard_assets }}/skrn/icons/fontawesome/css/fontawesome-all.min.css">
    <link href="{{ $dashboard_assets }}/assets/css/users/user-profile.css" rel="stylesheet" type="text/css" />

    <!-- FontAwesome Icons -->
    <link rel="stylesheet" href="{{ $dashboard_assets }}/skrn/icons/Iconsmind__Ultimate_Pack/Line%20icons/styles.min.css">
    <!-- iconsmind.com Icons -->
    ...
    <link rel="stylesheet" href="{{ $dashboard_assets}}/asap/css/fontawesome.css">
    <link rel="stylesheet" href="{{ $dashboard_assets}}/asap/css/templatemo-stand-blog.css">
    <link rel="stylesheet" href="{{ $dashboard_assets}}/asap/css/owl.css">
