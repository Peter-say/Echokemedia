                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info ">
                            <a href="{{$admin_assets}}/assets/img/m-icon.jpeg" target="_blank" rel="noopener noreferrer">
                                <img class="image img-fluid rounded" src="{{$admin_assets}}/assets/img/m-icon.jpeg" alt="" target="_blank">
                            </a>
