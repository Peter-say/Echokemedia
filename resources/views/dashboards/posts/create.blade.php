                            ...
                            <div class="widget-content widget-content-area">
                                <form enctype="multipart/form-data" class="form-row"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" type="file" name="cover_music">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="category_id" class="form-control" id="">
                                            ...
                                            @foreach ($categories as $category)
                                                <option id="category" value="{{ $category->id }}">{{ $category->name }}
                                                </option>
                                            @endforeach
                                            @if ($category->subcategory)
                                                @foreach ($category->subcategory as $subcategory)
                                                    <option id="subcategory" value="{{ $subcategory->Id }}">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" maxlength="80" name="type"
                                            value="{{ $types }}" placeholder="{{ $types }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input class="form-control" type="text" name="meta_title" required
                                            placeholder="{{ old('meta_keywords') ?? 'Describe the post. if empty it uses the blog title...' }}">
                                    </div>
                                    <div class="form-group col-md-7">
                                        ...
                                        <input class="form-control" type="text" name="meta_keywords" required
                                            placeholder="{{ old('meta_keywords') ?? 'Enter search keywords...' }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" maxlength="150" type="text"
                                            ...
                                            placeholder="{{ old('meta_keywords') ?? 'Summarize the blog post' }}">
                                    </div>
