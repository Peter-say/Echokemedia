  ...
  <div class="header-container fixed-top">
      <header class="header navbar navbar-expand-sm">
          ...
          <ul class="navbar-item theme-brand flex-row  text-center">
              {{-- <li class="nav-item ">
                  <a href="/">
                      <img class="ui fluid image" src="{{ $dashboard_assets }}/assets/img/m-icon.jpeg">
                  </a>
              </li> --}}
              ...
              <li class="nav-item dropdown user-profile-dropdown">
                  <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                      ...
                      @if (Auth::user()->avatar == null)
                          <img class="img-fluid" src="{{ asset('avatar/user-profile.png') }}"
                              alt="avatar">
                      @else
                  ...
                  <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                      <div class="">
                          <div class=" dropdown-item">
                              <a href="{{ route('dashboard.profile.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div class="dropdown-item">
                            <a class="" href="{{route('dashboard.user.settings.index')}}"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-setting">
                                    <polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline>
                                    <path
                                        d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z">
                                    </path>
